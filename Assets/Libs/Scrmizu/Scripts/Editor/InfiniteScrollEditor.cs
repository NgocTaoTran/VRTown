...
namespace Scrmizu.Editor
{
    ...
    public class InfiniteScrollEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _ignoreContentSize;
        ...
        protected void OnEnable()
        {
            ...
            _ignoreContentSize = serializedObject.FindProperty("ignoreContentSize");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_ignoreContentSize);
