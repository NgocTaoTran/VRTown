...
namespace VRTown.Scene
{
    ...
    public partial class UIManager : MonoBehaviour
    {
        ...
        // public void SetTextLevel(LevelData levelData)
        // {
        //     _textDescription.text = string.Format("Level {0}: {1} tiles", levelData.Index, levelData.Tiles.Count);
        // }

        // public void SetMessage(string message)
        // {
        //     _textDescription.text = string.Format("Message: {0}", message);
        // }
    }
}
